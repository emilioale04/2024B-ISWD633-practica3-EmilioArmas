...
### Comando completo con la ruta del contenedor
```
...
### Comando completo con el correo
```
docker run -d --name client-postgres --publish published=9500,target=80 -e PGADMIN_DEFAULT_PASSWORD=54321 -e PGADMIN_DEFAULT_EMAIL=user@drupal.com --network net-drupal dpage/pgadmin4
```
